...
ALL_BENCHMARKS = {"AT1", "AT2", "AT51", "AT52", "AT53", "AT54", "AT61", "AT62", "AT63", "AT64", "CC1", "CC2", "CC3", "CC4", "CC5", "CCx", "NN1", "NNx", "AFC27", "AFC29", "AFC33", "SC1"}
...
def _get_benchmark(name, results_folder):
    if "AT" in name:
        ...
        mod = import_module(f"AFC_benchmark.run_{name}")
    elif "SC" in name:
...
if __name__ == "__main__":
    ...
    parser.add_argument("-f", "--folder", default = "ARCHCOMP2022_PartX_Instance2_UR")
